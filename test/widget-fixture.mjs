...
export async function widgetSite(t) {
  ...
  const server = createServer(async (req, res) => {
    ...
    <script>
      const mode=${JSON.stringify(mode)};window.wrongClicks=0;window.monthClicks=0;window.selectionClicks=0;
      ...
      destination.oninput=()=>{selectedPlace='';destination.setAttribute('aria-expanded','true');places.hidden=false;places.innerHTML='';setTimeout(()=>{
